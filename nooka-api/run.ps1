...
$mapping = @{
    ...
    NOOKA_MEDIA_PROVIDER = 'MEDIA_PROVIDER'
    NOOKA_MEDIA_LOCAL_ROOT = 'MEDIA_LOCAL_ROOT'
    NOOKA_R2_ENDPOINT = 'R2_ENDPOINT'
    NOOKA_R2_REGION = 'R2_REGION'
    NOOKA_R2_BUCKET = 'R2_BUCKET'
    NOOKA_R2_ACCESS_KEY = 'R2_ACCESS_KEY'
    NOOKA_R2_SECRET_KEY = 'R2_SECRET_KEY'
}
