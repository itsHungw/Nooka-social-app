...
@Component
class GoogleIdentityVerifier implements OAuthIdentityVerifier {

    private final JwtDecoder decoder;

    GoogleIdentityVerifier(@Qualifier("googleJwtDecoder") JwtDecoder decoder) {
    ...
    public OAuthIdentity verify(String token) {
        try {
            ...
            throw new AuthException(HttpStatus.UNAUTHORIZED, "Google authentication failed");
        }
    }
}
